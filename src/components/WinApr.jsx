...
const WinApr = () => {
  return (
    <>
    <div className='flex lg:justify-start lg:ml-8 justify-center'>
      <div className="w-[360px] h-32 relative bg-[#a2e5b3] rounded-xl mt-8  flex items-center overflow-hidden">
        <div className="ml-6">
