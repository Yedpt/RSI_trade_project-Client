...
import { HiArrowLeft, HiUser, HiBell, HiChat, HiCreditCard, HiCog, HiMap } from "react-icons/hi";
  ...
  return (
    <div className="bg-[#1e1e2d] text-white min-h-screen flex flex-col">
      <div className="flex items-center justify-between px-4 py-3">
        <button onClick={handleReturn} className="p-2 rounded-full hover:bg-gray-700">
          <HiArrowLeft size={20} />
        </button>
      ...
      <div className="flex flex-row items-center text-center py-6 ml-6 gap-5 mt-2">
        <div className="bg-gray-500 rounded-full h-16 w-16 flex items-center justify-center">
          <button><Avatar sx={{ bgcolor: deepPurple[800], width: 60, height: 60 }}>
